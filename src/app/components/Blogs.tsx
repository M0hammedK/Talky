...
import { fetchBlogs, BlogPost } from "../../services/PostServices";
    ...
    <div className="animate-spin rounded-full h-12 w-12 border-4 border-blue-500 border-t-transparent"></div>
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-5 leading-relaxed">detailes</p>
          ...
          <div className="flex items-center gap-3">
            <img
              ...
              className="w-8 h-8 rounded-full"
            />
            <span className="font-medium text-gray-700">user or deleted</span>
          </div>
        </div>
